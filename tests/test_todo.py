...
class TestTodo(unittest.TestCase):
    def test_parse_summary(self):
        f = open('assets/vcalendar-vtodo1.ics', 'r')
        test = f.read()
        todo = Todo(test)
    ...
    def test_parse_created(self):
        f = open('assets/vcalendar-vtodo2.ics', 'r')
        test = f.read()
        todo = Todo(test)
    ...
    def test_parse_dtstamp(self):
        f = open('assets/vcalendar-vtodo3_1_1.ics', 'r')
        test = f.read()
        todo = Todo(test)
    ...
    def test_parse_last_modified(self):
        f = open('assets/vcalendar-vtodo3_1.ics', 'r')
        test = f.read()
        todo = Todo(test)
    ...
    def test_uid(self):
        f = open('assets/vcalendar-vtodo3.ics', 'r')
        test = f.read()
        todo = Todo(test)
    ...
    def test_str(self):
        f = open('assets/vcalendar-vtodo7.ics', 'r')
        test = f.read()
        todo = Todo(test)
